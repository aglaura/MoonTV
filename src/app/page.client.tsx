              ...
              <div className={mainLayoutClass}>
                <div className="flex flex-col gap-6 sm:gap-8">
                  ...
                  <section
                    ...
                    className={`rounded-2xl border border-gray-200/60 dark:border-gray-800 bg-gradient-to-r from-gray-900 via-gray-900 to-gray-800 dark:from-black dark:via-gray-900 dark:to-gray-800 shadow-lg overflow-hidden ${tvSectionClass(
                      'hero'
                    )}`}
                  >
                        ...
                        <div className="relative">
                          <div className="flex gap-3 overflow-x-auto pb-2 [-ms-overflow-style:'none'] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                            {heroItems.slice(0, 10).map((item, idx) => {
                              const active =
                                heroIndex % heroItems.length === idx;
                              return (
                                <button
                                  key={`${item.title}-${idx}`}
