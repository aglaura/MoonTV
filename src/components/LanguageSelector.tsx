...
export default function LanguageSelector() {
  ...
  const currentLanguage = languageOptions.find(lang => lang.value === userLocale) 
  ...
  return (
    <div className="w-40">
      <Listbox value={currentLanguage} onChange={(lang) => changeLanguage(lang.value)}>
        <div className="relative">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white dark:bg-gray-800 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
