...
const renderPersonCard = (
  ...
  return (
    <Link
      ...
      data-tv-card="true"
      className={`tv-card group flex h-full flex-col items-center justify-center gap-3 rounded-2xl border p-4 transition hover:-translate-y-0.5 hover:shadow-lg ${
        isTv
